...
export function BrowsePageClient({
  ...
  const filteredCourses = useMemo(() => {
    ...
    return filtered;
  }, [initialCourses, searchQuery, selectedLevel, sortBy]);
  ...
  const breadcrumbText = subcategory
    ...
    <div className="mt-5 space-y-6 pt-8 md:pt-12">
      ...
      <div className="flex flex-col space-y-2">
        ...
        <p className="text-muted-foreground">
          {subcategory
            ? `Explore ${subcategory} courses in ${category}`
            : category
            ? `Discover our ${category.toLowerCase()} courses designed to help you achieve your learning goals.`
      ...
      {filteredCourses.length > 0 ? (
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-sm text-muted-foreground mb-4">
            {subcategory
              ? `No ${subcategory} courses found in ${category}. Try adjusting your search or filters.`
              : category
              ? `No ${category.toLowerCase()} courses found. Try adjusting your search or filters.`
