            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              {bio && bio.length > 0
                ...
                : dbUser?.role === "instructor"
                  ? "Share a short professional bio so students can learn more about your expertise."
                  : "Add a short bio to let instructors know more about your background and goals."}
            </p>
          </div>
        </CardContent>
      </Card>
